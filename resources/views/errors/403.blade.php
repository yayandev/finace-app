...
<html
  ...
  <head>
    ...
    <title>Not Authorized - Pages | Materialize - Material Design HTML Admin Template</title>
      ...
      <div class="d-flex justify-content-center mt-5">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            ...
            width="160" />
          <div>
            <a href="/dashboard" class="btn btn-primary text-center my-4">Back to home</a>
          </div>
        </div>
      </div>
    </div>
