...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="mb-3">
            <div class="card-header d-flex justify-content-between flex-wrap mb-3">
                <h5 class="m-0">Laporan Pengeluaran</h5>
                <a href="/transactions/export?type=keluar" id="btn-export" class="btn btn-success">
